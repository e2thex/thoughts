...
#### Schema Development Through Training

While a schema is fixed, new schemas are created as incremental changes to the previous ones through training, refined through exposure, feedback, and repetition. In training, we do not simply memorize actions. We reshape the underlying simulator.
...
The reality schema is the brain's amalgamated simulation engine, where all these seemingly separate [Schemas](/schematic-approach/foundation/Schemas) blend and flow into one another. It is a continuously updated probabilistic model that is not just a combination of these different aspects of experience, but an integration of them.
...
Before we discuss how the Schematic Approach can help us understand consciousness, let's consider two related but distinct attributes of consciousness: its nature and its unit.
...
The concept that we call consciousness is reality, or more specifically, each reality is a consciousness. While we speak of a Reality (reality nought or $R_0$), each of us does not directly experience it; instead, we each experience our individual [reality schema](/schematic-approach/foundation/Reality-schema) ($R_p$).
